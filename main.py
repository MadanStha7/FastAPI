...
from ecommerce.authentication import get_hashed_password, verify_token, token_generator
...
async def user_registrations(user: user_pydanticIn):
    ...
    return {
        "status": "ok",
        "data": f"Hello {new_user.username}, thanks for choosing us. Please check your email inbox and click the link to confirm your registration.",
    }
    ...
    return {
        ...
        "data": {
            ...
            "business_detail": {
                ...
                "email": owner.email,
                "joined_date": owner.joined_date.strftime("%b %d %Y"),
            },
        },
    }
...
async def update_product(
    ...
    update_info["published_date"] = datetime.utcnow()
...
register_tortoise(
    ...
    modules={"models": ["ecommerce.models"]},
